...
if __name__ == "__main__":
    output_folder = os.path.join(PROJECT_ROOT, "results", "Total_cut", "viz", "time_windows")
    total_cut_path = os.path.join(PROJECT_ROOT, "data", "Total_cut", "Total.csv")
    tw_path = os.path.join(PROJECT_ROOT, "results", "Total_cut", "time_windows.csv")
    plot_time_windows(total_cut_path, tw_path, output_folder)